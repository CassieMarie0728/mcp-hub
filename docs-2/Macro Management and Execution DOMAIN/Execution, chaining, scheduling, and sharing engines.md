...
_`lib/engines/MacroExecutionEngine.ts`_
...
_`server/scheduling/macro-scheduler.ts`_
...
_Used by `MacroManager` and `MacroSchedulingEngine`_
...
_Used by `MacroSchedulingEngine`_
