...
_`app/(tabs)/macro-builder.tsx`_
...
_`app/(tabs)/macro-gallery.tsx`_
...
_`app/(tabs)/workflow-templates.tsx`_
...
_`app/(tabs)/macro-chaining.tsx`_
...
_`app/(tabs)/macro-scheduling.tsx`_
...
_`app/macro-scheduler-ui.tsx`_
...
_`app/(tabs)/macro-sharing.tsx`_
...
_`app/macro-version-history.tsx`_
...
_`app/(tabs)/schedule-workflow.tsx`_
...
_`components/SaveAsMacroModal.tsx`_
...
_`lib/engines/MacroChainingEngine.ts`_
...
_`lib/engines/MacroSchedulingEngine.ts`_
...
_`lib/engines/MacroSharingEngine.ts`_
...
_`lib/models/ExecutionHistory.ts`_
...
_`server/templates/workflow-templates.ts`_
...
_`lib/utils/ResultDisplayFormatter.ts`_
...
_Used by `MacroSchedulingEngine` and `ExecutionHistoryManager`_
...
_Used by `MacroSchedulingEngine.initialize`_
...
_Used by `MacroSharingEngine` and `app/(tabs)/macro-sharing.tsx`_
