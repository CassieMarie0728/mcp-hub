...
| [Docker & Kubernetes](./docker.md) | Container image, compose file, and the provided manifests. |

## Suggested reading order

Self-hosting? Start at [Installation overview](./installation-overview.md) → [Local development](./local-development.md) → [Environment variables](./environment-variables.md). Deploying in containers? Jump to [Docker & Kubernetes](./docker.md) after the overview.
