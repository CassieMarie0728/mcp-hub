    ...
    <ScreenContainer className="p-0">
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        <View className="bg-primary px-6 py-8">
          <Text className="text-xs text-background/70 font-bold tracking-widest mb-2">RECEIPTS</Text>
        ...
        <View className="mx-6 mb-8 p-6 bg-surface rounded-lg border border-border">
          ...
          <Text className="text-sm text-muted leading-relaxed">
            Evidence first. Polish second. When the product earns real wins, this page can show them.
          </Text>
        </View>
      </ScrollView>
    </ScreenContainer>
