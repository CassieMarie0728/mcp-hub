...
const MISSIONS: Mission[] = [
  {
    ...
    icon: 'source-branch',
    description:
      'Keep GitHub work close: issues, pull requests, actions, and release chores in one operating view.',
    moves: [
      'Check repository status',
      'Open or review issues',
      'Track workflow results',
      'Send updates without tab hopping',
    ],
    fieldNote:
      'For the days when the code is fine, the process is not, and you need a clean command path.',
    color: '#981518',
  },
  {
    id: 'ops-check',
    ...
    icon: 'cloud-queue',
    description:
      'Watch connected systems, test links, and see which tools are ready before you trust them with real work.',
    moves: [
      'Scan connected servers',
      'Test service connections',
      'Review execution history',
      'Spot broken links early',
    ],
  ...
  },
  {
    ...
    icon: 'build',
    description:
      'Turn repeated steps into reusable workflows that can be tested, saved, scheduled, and improved.',
    moves: [
      'Build multi-step macros',
      'Add conditions and loops',
      'Run dry checks',
      'Save the useful ones',
    ],
    fieldNote:
      'If you have done the same task three times, the machine can start carrying part of that load.',
    color: '#22C55E',
  },
  {
    id: 'client-work',
    ...
    icon: 'briefcase',
    description:
      'Keep different client or project systems separated while still working from one hub.',
    moves: [
      'Name each server clearly',
      'Keep histories readable',
      'Group tools by purpose',
      'Hand off cleaner notes',
    ],
    fieldNote:
      'Useful when your projects multiply like gremlins and every one of them has its own tool pile.',
    color: '#5AC8FA',
  },
  {
    id: 'ai-helper',
    ...
    icon: 'smart-toy',
    description:
      'Use the assistant to find the right tool, explain what happened, and guide the next move.',
    moves: [
      'Ask what tool fits the job',
      'Summarize execution output',
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        <View className="bg-primary px-6 py-8">
          ...
          <Text className="text-base text-background/90 leading-relaxed">
            No inflated case-study theater. Just practical ways this hub can help you control the
            tool pile.
          </Text>
        </View>
        ...
        <View className="mx-6 mb-8 p-6 bg-surface rounded-lg border border-border">
          ...
          <Text className="text-sm text-muted leading-relaxed">
            MCP Hub is not here to decorate your workflow. It is here to make scattered tools easier
            to connect, run, inspect, and improve.
          </Text>
        </View>
