          ...
          <View className="flex-1 gap-6 justify-center">
            ...
            <View className="bg-surface rounded-2xl p-4 gap-2">
              ...
              <Text className="text-sm text-muted">
                {currentStep === 0 && "MCP Hub lets you automate tasks across multiple platforms without writing code."}
                {currentStep === 1 && "You can connect multiple servers and create workflows that span across them."}
                {currentStep === 2 && "Your credentials are encrypted and never stored in plain text."}
                ...
                {currentStep === 5 && "You can create unlimited workflows and manage them all from one place."}
              </Text>
            </View>
          </View>
