      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        <View className="flex-1 gap-6">
          ...
          <View className="gap-2">
            <Text className="text-2xl font-bold text-foreground">Schedule Workflows</Text>
            <Text className="text-sm text-muted">Set up recurring automation</Text>
          </View>
          ...
          <View className="gap-3">
            <Text className="text-sm font-semibold text-foreground">Quick Examples</Text>
          ...
          {/* Active Schedules */}
          <View className="gap-3">
            <Text className="text-sm font-semibold text-foreground">Active Schedules</Text>
            {schedules.map((schedule) => (
              <View key={schedule.id} className="bg-surface rounded-xl p-4 gap-2">
                ...
                <Text className="text-xs text-muted">Next run: {schedule.nextRun}</Text>
              </View>
            ))}
          </View>
