...
const LOG_ITEMS: LogItem[] = [
  {
    ...
    excerpt:
      'Document how each server gets added, what credentials it needs, and what errors users may hit first.',
    category: 'Setup',
    status: 'Draft slot',
  },
  {
    ...
    excerpt:
      'Keep examples of useful workflows, the steps they need, and where the builder still needs guardrails.',
    category: 'Workflows',
    status: 'Draft slot',
  },
  {
    ...
    excerpt:
      'Collect common failure patterns, what they mean, and how to trace a workflow without losing the plot.',
    category: 'Debugging',
    status: 'Draft slot',
  },
  {
    ...
    excerpt:
      'Track what is real, what is next, and what should not be promised before the product earns it.',
    category: 'Roadmap',
    status: 'Draft slot',
  },
];
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        <View className="bg-primary px-6 py-8">
          ...
          <Text className="text-base text-background/90 leading-relaxed">
            This is the future home for docs, release notes, setup guides, and practical field
            notes.
          </Text>
        </View>
            ...
            <Pressable className="flex-row items-center gap-3 py-3 border-b border-border">
              ...
              <View className="flex-1">
                ...
                <Text className="text-xs text-muted">
                  Reusable workflow patterns and sample configs.
                </Text>
              </View>
              <Ionicons name="chevron-forward" size={20} color={colors.muted} />
            </Pressable>
        ...
        <View className="mx-6 mb-8 p-6 bg-primary rounded-lg">
          ...
          <Text className="text-sm text-background/90">
            Add subscriptions only when there is a real list, a real send plan, and something worth
            mailing.
          </Text>
        </View>
      </ScrollView>
