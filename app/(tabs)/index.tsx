        ...
        >
          <View className="bg-primary px-6 pt-8 pb-12 flex-row items-start justify-between">
            <View className="flex-1 pr-4">
              ...
              <Text className="text-base text-background/95 font-semibold leading-relaxed">
                One command bunker for your MCP servers, tools, automations, and the weird little
                gremlins that keep them alive.
              </Text>
              <Text className="text-sm text-background/75 mt-3 leading-relaxed">
                Connect the servers. Run the tools. Watch the fallout. Fix the mess before it grows
                teeth.
              </Text>
            </View>
          ...
          <View className="px-6 mb-8">
            ...
            <Text className="text-sm text-muted mb-4 leading-relaxed">
              MCP Hub is the place you go when your tools are scattered across ten tabs, three
              dashboards, and one panic spiral. It pulls the mess into one mobile-first command
              center.
            </Text>
            <FeatureCard
              icon="cloud-sync"
            ...
            <View className="flex-row items-center justify-between mb-4">
              ...
              {servers.length > 0 && (
                <Button
                  variant="ghost"
                  size="small"
                  onPress={() => router.push('/(tabs)/mcp-servers' as any)}
                >
                  See All
                </Button>
              )}
            ...
            <View className="px-6 mb-8">
              ...
              {[
                [
                  '1',
                  'Connect a server',
                  'Add GitHub, Slack, Notion, or whatever MCP endpoint you are wrangling.',
                ],
                [
                  '2',
                  'Discover the weapons',
                  'Pull in the tools and commands that server can actually run.',
                ],
                [
                  '3',
                  'Execute and audit',
                  'Run the action, check the result, and keep the receipts.',
                ],
          ...
          <View className="px-6 py-6 border-t border-border">
            <Text className="text-xs text-muted text-center mb-2">
              Built for developers who want control, not confetti.
            </Text>
            <Text className="text-xs text-muted text-center">
              MCP Hub keeps the tools close and the bullshit on a leash.
            </Text>
          </View>
        </ScrollView>
